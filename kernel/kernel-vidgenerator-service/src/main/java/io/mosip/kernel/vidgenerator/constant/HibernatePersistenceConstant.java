...
public class HibernatePersistenceConstant {
	 ...
	 */
	public static final String JAVAX_PERSISTENCE_JDBC_PASS = "vid_database_password";
	/**
	 * The string field JAVAX_PERSISTENCE_JDBC_USER
	 */
	public static final String JAVAX_PERSISTENCE_JDBC_USER = "vid_database_username";
	/**
	 * The string field JAVAX_PERSISTENCE_JDBC_URL
	 */
	public static final String JAVAX_PERSISTENCE_JDBC_URL = "vid_database_url";
	/**
