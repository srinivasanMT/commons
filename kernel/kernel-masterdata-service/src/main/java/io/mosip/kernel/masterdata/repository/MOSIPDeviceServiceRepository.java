...
public interface MOSIPDeviceServiceRepository extends BaseRepository<MOSIPDeviceService, String> {
	...
	// MOSIPDeviceService findByDeviceProviderIdAndSwVersionAndMakeAndModel(String
	// deviceProviderId, String swVersion,String make,String model);
	 ...
	 * @param make
	 * @param model
	 * @return {@link MOSIPDeviceService}
	 */
	MOSIPDeviceService findByDeviceProviderIdAndRegDeviceTypeCodeAndRegDeviceSubCodeAndMakeAndModel(
			String deviceProviderId, String type, String subType, String make, String model);
